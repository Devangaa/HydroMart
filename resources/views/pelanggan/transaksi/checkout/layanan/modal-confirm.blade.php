{{-- ============================================================================= --}}
{{-- FILE: pelanggan/transaksi/checkout/layanan/modal-confirm.blade.php --}}
{{-- HALAMAN: Modal Konfirmasi Checkout Layanan --}}
{{-- DESKRIPSI: Popup konfirmasi sebelum memesan layanan. --}}
{{-- ============================================================================= --}}

{{-- Modal: Konfirmasi Pesanan Layanan --}}
<template x-teleport="body">
    ...
    >
        ...
        >
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2">Konfirmasi Pesanan Layanan</h3>
            <p class="text-gray-500 text-sm mb-4 leading-relaxed">
                Pastikan lokasi layanan, jadwal, dan metode pembayaran sudah benar sebelum melanjutkan.
            </p>
            <p class="text-sm font-bold text-gray-700 mb-8">
                Total pembayaran:
                <span class="text-green-600 text-lg" x-text="'Rp' + formatCurrency(finalTotal)"></span>
            </p>
            ...
            <div class="flex flex-col gap-3">
                <button
                    ...
                    :class="isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-green-700 active:scale-95 shadow-lg shadow-green-100'"
                ...
                >
                    ...
                    <span x-text="isSubmitting ? 'Memproses...' : 'Ya, Pesan Layanan'"></span>
                </button>
                <button
                    type="button"
