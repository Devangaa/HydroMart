...
<div class="bg-white p-8 md:p-10 rounded-[2.5rem] shadow-sm border border-gray-100 w-full max-w-md">
    ...
    <form action="{{ route('login') }}" method="POST">
        ...
        <div class="flex flex-col items-end mb-6">
            <a href="#" class="text-[11px] text-green-600 font-bold hover:underline mb-2">Lupa Password?</a>
        ...
        <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3.5 rounded-xl transition duration-300 transform active:scale-[0.98] shadow-lg shadow-green-100">
            Login
        </button>
