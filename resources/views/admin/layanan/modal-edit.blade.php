<template x-teleport="body">
    <div x-show="showEditModal" 
        ...
        <div @click.away="showEditModal = false" class="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-3xl max-h-[90vh] overflow-y-auto overflow-x-hidden relative text-left">
            <div class="sticky top-0 bg-white px-8 py-6 border-b border-gray-50 flex justify-between items-center z-10 text-gray-900">
            ...
            <form :action="editUrl" method="POST" enctype="multipart/form-data" class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2 space-y-2 text-left">
                        <label class="text-sm font-bold text-gray-700 ml-1">Ubah Foto Layanan (Opsional)</label>
                ...
                <div class="mt-10 flex justify-end gap-4">
                    ...
                    <button type="submit" class="px-8 py-4 bg-green-600 text-white font-bold rounded-2xl shadow-lg shadow-green-100 hover:bg-green-700 transition-all">Simpan Perubahan</button>
                </div>
            </form>
        </div>
    </div>
